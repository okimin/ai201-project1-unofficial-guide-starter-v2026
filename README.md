...
```
(.venv) ai201-project1-unofficial-guide-starter-v2026 $python app.py ask "is the housing lottery random?"
...
1 model calls this session, 675 tokens (617 in, 58 out)
(.venv) ai201-project1-unofficial-guide-starter-v2026 $python app.py chunks -n 5                         
