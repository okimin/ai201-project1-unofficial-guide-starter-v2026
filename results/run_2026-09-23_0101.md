...
```
Based on the provided documents, both The Atrium and North Kitchen have a wait figure/time of "no queue" (*dining_the_atrium.txt*, *dining_the_atrium_followup.txt*, and *dining_north_kitchen_followup.txt*).
```
...
- For The Atrium, this comes from `dining_the_atrium.txt` and `dining_the_atrium_followup.txt`.
